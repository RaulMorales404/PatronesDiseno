...
class SalesReport implements Report {
  ...
  generate(): void {
    console.log("Reporte Ventas %c256", COLORS.green);
  }
}
...
class InventoryReport implements Report {
  ...
  generate(): void {
    console.log("Reporte Inventario %c500", COLORS.blue);
  }
}

class MoreSalesReport implements Report {
  generate(): void {
    console.log("Reporte mas vendido  chanclas %c$500", COLORS.purple);
  }
}
...
class MoreSalesReportFactory extends ReportFactory {
  override createReport(): Report {
    return new MoreSalesReport();
  }
}
...
function main() {
  ...
  const reportType = prompt(
    "¿Qué tipo de reporte deseas? (sales/inventory/more)",
  ...
  switch (reportType) {
    ...
    case "inventory":
      ...
      break;
    case "more":
      reportFactory = new MoreSalesReportFactory();
      break;
