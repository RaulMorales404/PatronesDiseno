...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    ...
    if (!DatabaseConnection.instance) {
      ...
      console.log("%cConeactado a la base de datos", COLORS.green)
  ...
  public connect(): void {
    if (this.connected) {
      console.log("%cYa existe una  Conexion", COLORS.red, this.connected);
      return;
      // Completar: si no está conectado, mostrar mensaje de conexión
    }
    this.connected = true;
    console.log("Nueva conecion %cEstablecida", COLORS.blue, this.connected);
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      ...
      console.log("%cDesconectamos la conexion a la base de datos", COLORS.violet, this.connected);
      return;
    }
     console.log("%cAun no hay una conexion", COLORS.orange, this.connected);
    return;
