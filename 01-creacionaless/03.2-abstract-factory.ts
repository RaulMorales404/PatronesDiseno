...
class ElectricCar implements Vehicle {
  assemble(): void {
    console.log("Auto ensablado de %cElectrio",COLORS.blue);
  }
...
class GasCar implements Vehicle {
  assemble(): void {
   console.log("Auto ensablado de %cCombustion",COLORS.red);
  }
  // Implementación del método assemble
...
class ElectricEngine implements Engine{
  start(): void {
    console.log('Arrancando motor Electrico %cBUFBUF',COLORS.blue);
  }
...
class GasEngine implements Engine {
  start(): void {
    console.log('Arrancando motor Combustion %cRunRun',COLORS.white);
  }
  // Implementación del método start
