...
class ComputerFacade {
  ...
  protected mempri: Memory;

  // TODO: Agregar el constructor para instanciar los atributos CPU, Memory y HardDrive
  constructor(params: configComputer) {
    this.cpu = params.cpu;
    this.hardDrive = params.harDrive;
    this.mempri = params.memory;
  }
  ...
  startComputer(): void {
    ...
    this.mempri.load(0, this.hardDrive.read(0, 1024));
    this.cpu.jump(0);
    this.cpu.execute();
