...
class PayPalAdapter implements PaymentProcessor {
  private PayPalServiceMethod = new PayPalService();
  constructor() {}

  processPayment(amount: number): void {
    this.PayPalServiceMethod.sendPayment(amount);
    return;
  }
...
class StripeAdapter implements PaymentProcessor {
  private StripeServiceMethod = new StripeService();
  constructor() {}

  processPayment(amount: number): void {
    this.StripeServiceMethod.makeCharge(amount);
    return;
  }
  // TODO: Implementar la interfaz PaymentProcessor
}
...
class MercadoPagoAdapter implements PaymentProcessor {
  private MercadoPagoServiceMethod = new MercadoPagoService();
  constructor() {}

  processPayment(amount: number): void {
    this.MercadoPagoServiceMethod.pay(amount);
    return;
  }
  // TODO: Implementar la interfaz PaymentProcessor
}
...
function main() {
  const amount = prompt(" Cuanto vas a pagar ? :")
