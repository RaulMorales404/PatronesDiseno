...
//import { localLoger } from "./adapter-files/local-logger.ts";


const logger = new  DenoLoggerAdapter('01-adapter.ts');

logger.writeLog("Connectidos Suceess"); 
logger.writeWarning("Alerta violacion");
logger.writeError("Ocurrio un error al conectarse");